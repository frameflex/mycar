...
class DocumentsGalleryScreen extends StatefulWidget {
  const DocumentsGalleryScreen({Key? key}) : super(key: key);

  @override
  _DocumentsGalleryScreenState createState() => _DocumentsGalleryScreenState();
}

class _DocumentsGalleryScreenState extends State<DocumentsGalleryScreen> {
